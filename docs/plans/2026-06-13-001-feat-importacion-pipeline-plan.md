...
- Firebase project: **\`context-layer-93a65\`** — nuevo, sin Cloud Functions ni colecciones previas. ContextLayer escribe solo bajo el namespace `users/{uid}/`; no tocar ni eliminar colecciones ni funciones existentes.
